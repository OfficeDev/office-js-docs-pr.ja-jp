...
1. <span data-ttu-id="b1b90-152">ループを2つのループに置き換えます。</span><span class="sxs-lookup"><span data-stu-id="b1b90-152">Replace the loop with two loops.</span></span>
