...
次のセクションでは、Windows ベースのデバイス、Mac OS X デバイス、および web ブラウザーでの Office クライアントでのアドインの実行をランタイムアーキテクチャがどのようにサポートしているかを簡単に説明します。
...
![リッチクライアントインフラストラクチャを示す図](../images/dk2-agave-overview-02.png)

次の図に示すように、Mac OS X デスクトップでは、アドイン web ページはセキュリティで保護された WebKit ランタイムホストプロセスの内部でホストされており、同様のレベルのセキュリティとパフォーマンス保護を提供します。

*図2Mac OS X クライアントでの Office アドインのランタイム環境*

![Mac OS X 上の Office ランタイム環境のアプリを示す図](../images/dk2-agave-overview-mac-02.png)
...
![Web クライアントインフラストラクチャを示す図](../images/dk2-agave-overview-03.png)
