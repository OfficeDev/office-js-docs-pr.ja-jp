...
1. ブラウザーが REST クエリから XML データを直接表示するには、フィード読み取りビューをオフにします。 この方法については、「レポート データのクエリ OData フィードInternet Explorer手順 1、手順 4」を参照[Project参照してください](/previous-versions/office/project-odata/jj163048(v=office.15))。
