...
|1008|データの読み取りエラー|要求されたデータ セットが大きすぎます。|ユーザーが、Office アプリケーションによって定義されたデータの制限を超えてデータを読み取ることを要求します。|
...
|2009|データの書き込みエラー|指定されたデータ オブジェクトが大きすぎます。|ユーザーが、Office アプリケーションで定義されたデータの制限を超えてデータを設定しようとしています。|
