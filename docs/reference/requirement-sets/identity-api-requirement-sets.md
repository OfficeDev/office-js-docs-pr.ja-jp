...
|  要件セット  | Office 2013 以降 (Windows)<br>(1 回限りの購入) | Windows 版 Office<br>(Office 365 サブスクリプションに接続) |  Office on iPad<br>(Office 365 サブスクリプションに接続)  |  Mac 版 Office<br>(Office 365 サブスクリプションに接続)  | Web 上の Office  | SharePoint Online | OneDrive.com |Outlook.com および Exchange Online|
|:-----|-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
