...
ms.locfileid: "63743105"
---
# <a name="context-mailbox-requirement-set-12"></a>context (メールボックス要件セット 1.2)

### <a name="officecontext"></a>[Office](office.md).context

Office.context は、すべてのアプリでアドインで使用される共有インターフェイスをOfficeします。 この一覧には、アドインで使用されるインターフェイスOutlook記載されています。Office.context 名前空間の完全な一覧については、common [API の Office.context リファレンスを参照してください](/javascript/api/office/office.context?view=outlook-js-1.2&preserve-view=true)。
