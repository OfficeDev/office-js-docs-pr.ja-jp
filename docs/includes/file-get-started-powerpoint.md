...
5. Visual Studio ?????????????? 2 ??????????????**??????? ????????**????????**Home.html** ????? Visual Studio ???????
...
1. Visual Studio ????????????? PowerPoint ??????????????????F5 ?????? **[??]** ??????????????? **[??????????]** ???? ????????? PowerPoint ???????????? IIS ???????????????
...
3. Yeoman ?????????????PowerPoint ???? ????????????? ???????????????????????????
    ...
    - **What would you want to name your add-in?: (??????????????)** `My Office Add-in`
    - **Which Office client application would you like to support?: (?? Office ?????? ?????????????????)** `PowerPoint`
    - **Would you like to create a new add-in?: (??????????????)** `Yes`
    - **Would you like to use TypeScript?: (TypeScript ???????)** `No`
...
????????PowerPoint ???????????????? ???PowerPoint ????????????????????PowePoint ??????????????????????????????????
