<span data-ttu-id="f4469-101">開発プロジェクトを設定して、このチュートリアルを始めます。</span><span class="sxs-lookup"><span data-stu-id="f4469-101">You'll begin this tutorial by setting up your development project.</span></span> 
