...
4. Visual Studio ?????????????? 2 ??????????????**??????? ????????**????????**Home.html** ????? Visual Studio ???????
...
1. Visual Studio ????????????? Word ??????????????????F5 ?????? **[??]** ??????????????? **[??????????]** ???? ????????? Word ???????????? IIS ???????????????
...
3. Yeoman ?????????????Word ???? ????????????? ??????????????????????????
    ...
    - **Which Office client application would you like to support?: (?? Office ?????? ?????????????????)** `Word`
