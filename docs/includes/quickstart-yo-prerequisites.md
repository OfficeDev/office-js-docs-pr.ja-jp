- <span data-ttu-id="6e51b-101">[Node.js](https://nodejs.org) (バージョン 8.0.0 以降)</span><span class="sxs-lookup"><span data-stu-id="6e51b-101">[Node.js](https://nodejs.org) (version 8.0.0 or later)</span></span>
