<span data-ttu-id="1cd7b-101">開発プロジェクトを設定して、このチュートリアルを始めます。</span><span class="sxs-lookup"><span data-stu-id="1cd7b-101">You'll begin this tutorial by setting up your development project.</span></span> 
