<span data-ttu-id="ca1cb-101">開発プロジェクトを設定して、このチュートリアルを始めます。</span><span class="sxs-lookup"><span data-stu-id="ca1cb-101">You'll begin this tutorial by setting up your development project.</span></span> 
