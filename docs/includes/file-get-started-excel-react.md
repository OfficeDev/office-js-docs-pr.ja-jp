# <a name="build-an-excel-add-in-using-react"></a><span data-ttu-id="91d6d-101">React を使用して Excel のアドインを構築する</span><span class="sxs-lookup"><span data-stu-id="91d6d-101">Build an Excel add-in using React</span></span>
