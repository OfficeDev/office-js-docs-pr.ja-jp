# <a name="build-an-excel-add-in-using-react"></a><span data-ttu-id="eed3b-101">React を使用して Excel のアドインを構築する</span><span class="sxs-lookup"><span data-stu-id="eed3b-101">Build an Excel add-in using React</span></span>
