...
|Web ブラウザー:<br>最新の Outlook UI|はい|該当なし|該当なし|該当なし|
|Web ブラウザー:<br>クラシック Outlook UI|対象外|なし|いいえ|いいえ|

> [!NOTE]
> \* オンプレミスの Exchange 環境でのこの機能のサポートは、現在のチャネルのバージョン 2206 (ビルド 15330.20000) と月次エンタープライズ チャネルのバージョン 2207 (ビルド 15427.20000) 以降で使用できます。
