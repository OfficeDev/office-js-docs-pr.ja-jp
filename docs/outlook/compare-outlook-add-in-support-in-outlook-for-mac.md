...
Outlook アドインは、クライアントごとに JavaScript をカスタマイズせずに、Outlook on the web、Windows、iOS、Android などの他のクライアントと同様に、Mac 上の Outlook で同じ方法で作成および実行できます。 アドインから JavaScript API への同じ呼び出Office、次の表に示す領域を除き、通常は同じように動作します。
...
Outlookは、要件セット 1.10 まで、新しい Mac UI (プレビュー) でサポートされています。 ただし、次の要件セットと機能 **はまだ** サポートされていません。

- API 要件セット 1.11

バージョン 16.38.506 からOutlook Mac UI のプレビューを行って下さい。 試し方の詳細については、「Insider Fast ビルドOutlook for Macリリース ノート」[を参照してください](https://support.microsoft.com/office/d6347358-5613-433e-a49e-a9a0e8e0462a)。
