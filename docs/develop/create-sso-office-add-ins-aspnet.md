...
1. `TODO4` を次のコードと置き換えます。エラー 13003 は、ユーザーが職場または学校アカウントと、Micrososoft アカウントのどちらでもないアカウントでログインしている場合に発生します。ユーザーにサインアウトするよう要求してから、サポートされているアカウント タイプで再度サインインします。
