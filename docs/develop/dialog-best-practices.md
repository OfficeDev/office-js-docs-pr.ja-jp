...
> 
> 「エラーと[イベントを処理する」を参照Officeしてください](dialog-handle-errors-events.md)。
...
ダイアログ ボックスの設計のベスト プラクティスについては、「ダイアログ ボックス」[を参照Officeアドインを参照してください](../design/dialog-boxes.md)。
