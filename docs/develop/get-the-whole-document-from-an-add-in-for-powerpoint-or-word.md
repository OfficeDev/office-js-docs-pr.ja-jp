...
また、[Visual Studio](../get-started/create-and-debug-office-add-ins-in-visual-studio.md) や[任意のエディター](../get-started/create-an-office-add-in-using-any-editor.md)を使用して、PowerPoint や Word 用アドインを作成できます。 
